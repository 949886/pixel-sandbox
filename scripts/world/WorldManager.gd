...
func _build_debug_snapshot(center: Vector2i) -> Dictionary:
	...
	return {
		...
		"chunk_attach_budget_ms": chunk_attach_budget_ms,
		"simulation_warmup_budget_ms": simulation_warmup_budget_ms,
		"simulation_texture_activation_budget_ms": simulation_texture_activation_budget_ms,
		"simulation_update_budget_ms": simulation_update_budget_ms,
		"collision_build_budget_ms": collision_build_budget_ms,
		"recycle_budget_ms": recycle_budget_ms,
		...
		"collision_sector_commits_per_physics_frame": collision_sector_commits_per_physics_frame,
