...
const ELEMENT_BUTTON: PackedScene = preload("res://painting/ui/element_selector/CustomElementButton.tscn")
const PLACEHOLDER_LABEL: PackedScene = preload("res://painting/ui/element_selector/PlaceholderLabel.tscn")
